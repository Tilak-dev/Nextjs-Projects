...
function FeaturedCourses() {
  const featuredCoursea = courseData.courses.filter((course:Courses)=>course.isFeatured);
  return (
    <div className=" py-12 bg-gray-900">
      ...
      <div className="mt-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
          {featuredCoursea.map((courses:Courses)=>(
            <div key={courses.id} className=" flex justify-center">
              <BackgroundGradient className=" flex flex-col rounded-[22px] bg-white dark:bg-zinc-900 overflow-hidden h-full max-w-sm">
                <div className=" p-4 sm:p-6 flex flex-col items-center text-center flex-grow">
                  ...
                  className="mt-8 px-3 py-1.5 rounded border border-neutral-600 text-neutral-700 bg-white hover:bg-gray-50 transition duration-200"
                  >Learn more</Link>
                </div>
              </BackgroundGradient>
            </div>
